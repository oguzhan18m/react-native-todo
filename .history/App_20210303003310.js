...
export default function App() {
  ...
  const addGoalHandler = (goalTitle) =>{
    setGoalsCourse(currentGoals => [...currentGoals, {id: Math.random().toString() ,value: goalTitle }]);
  }
  ...
  return (
    <ScrollView style={styles.screen}>
      ...
      data={courseGoals} 
      renderItem={itemData => <GoalItem onDelete={()=> console.log('work work work')} title={itemData.item.value} /> } 
      />
